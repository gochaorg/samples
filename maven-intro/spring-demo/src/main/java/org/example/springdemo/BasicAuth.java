...
//        mngConfig.withUser(u2);
        ...
        if( loginsConf!=null ){
            loginsConf.getAccounts().forEach( acnt -> {
                UserDetails u = User.withUsername(acnt.getUsername()).password(this.passwordEncoder().encode(acnt.getPassword())).roles("USER").build();
